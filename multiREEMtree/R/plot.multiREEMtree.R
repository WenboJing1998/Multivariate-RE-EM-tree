#' Plot the multivariate tree of a multiREEMtree object
#'
#' Plot the multivariate tree of a multiREEMtree object.
#'
#' @param x A multiREEMtree object.
#' @param ... Identical to the arguments in \link[mvpart]{text.rpart}
#'
#'
#' @return A plot of multivariate RE-EM tree.
#'
#' @import mvpart
#' @import MASS
...
#' plot(result)
#' @rdname plot.multiREEMtree
#' @export

plot.multiREEMtree <- function(x, ...){
   if(class(x)=="multiREEMtree"){
