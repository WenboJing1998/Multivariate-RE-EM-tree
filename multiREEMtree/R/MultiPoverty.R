...
#'   education shown.}
#'   \item{Survival.rate}{The probability (%) that a newborn baby will survive before reaching age five.}
...
#'   of public sector corruption.(0-100, lower index shows more corruption.)}
#'   \item{Democracy.index}{An index measuring the state of the democracy.}
